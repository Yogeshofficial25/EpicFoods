...
const OccasionFood = () => {
  const [selectedOccasion, setSelectedOccasion] = useState(occasions[0]); // Default to first occasion
  ...
  return (
    <div className="min-h-[80vh] p-6 sm:p-12 bg-gradient-to-br from-gray-50 via-white to-yellow-50">
      ...
      <div className="flex flex-wrap justify-center mt-10 gap-4">
        {occasions.map((occasion, index) => (
          <Button
            ...
            className={`text-sm sm:text-base px-6 py-3 rounded-full shadow-lg transition-all duration-300 transform hover:scale-105 ${
      ...
      {/* Display Food Options Based on Selected Occasion */}
      {selectedOccasion && (
